...
def extract_cuil(text, last_cuil, regex_pattern, exclude_match):
...
def split_pdf(input_pdf, last_cuil=None, file_name_template="{cuil}_Recibos_Gratificacion_2025-02.pdf", regex_pattern=r'\b\d{2}-(\d{8})-\d\b', exclude_match=""):
    generated_files = []
